...
const FinanceDashboard = () => {
    ...
    datasets: [
      {
        ...
        backgroundColor: [theme.palette.primary.main, theme.palette.primary_blue.main],
      },
    ],
  };
  ...
  const fundsData = [
    { name: 'ACM Lottery', amount: 309, color: theme.palette.primary.main, total: 400 },
    { name: 'ACM Stall', amount: 950, color: theme.palette.secondary_teal.main, total: 1000 },
    { name: 'ACM Show', amount: 550, color: theme.palette.secondary.main, total: 600 },
    { name: 'ACM Fundraiser', amount: 620, color: theme.palette.primary_blue.main, total: 800 },
    { name: 'ACM Fundraiser 2', amount: 170, color: theme.palette.secondary_blue.main, total: 300 },
  ];
          ...
          <Grid item xs={12} md={4} key={index}>
            ...
            >
              <Box>
                ...
                <Typography variant="h4" sx={{ color: "#3F51B5" }}>{item.amount}</Typography> {/* Changed text color */}
              </Box>
              <Box>{item.icon}</Box>
            </Card>
          </Grid>
          ...
          >
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={8}>
                <Box sx={{ height: 300 }}> {/* Fixed height for the line chart */}
                  <Line data={reportExpenseData} options={{ maintainAspectRatio: false }} />
                </Box>
              </Grid>

              {/* Pie Chart on the right */}
              <Grid item xs={12} md={4}>
                <Box sx={{ height: 300 }}> {/* Fixed height for the pie chart */}
        ...
        <Grid item xs={4}>
          ...
          >
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
              <Typography variant="h6" color="black">Funds</Typography>
              <Typography variant="body2" sx={{ color: '#3F51B5', cursor: 'pointer' }}>View all</Typography>
            </Box>
                ...
                return (
                  <Box key={index} sx={{ mb: 2 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                      <Typography sx={{ fontWeight: 500, color: fund.color }}>{fund.name}</Typography>
